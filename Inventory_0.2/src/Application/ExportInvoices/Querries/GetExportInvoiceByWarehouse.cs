...
public record GetExportInvoiceByWarehouse(string WarehouseId) : IRequest<List<ExportInvoiceDto>>;


public class GetExportInvoiceByWarehouseHandler : IRequestHandler<GetExportInvoiceByWarehouse, List<ExportInvoiceDto>>
{
    private readonly IApplicationDbContext _context;
    private readonly IMapper _mapper;

    public GetExportInvoiceByWarehouseHandler(IApplicationDbContext context, IMapper mapper)
    {
        _context = context;
        _mapper = mapper;
    }

    public async Task<List<ExportInvoiceDto>> Handle(GetExportInvoiceByWarehouse request, CancellationToken cancellationToken)
    {
        ...
        var query = from export in _context.ExportInvoices
                    ...
                    where export.WarehouseId == request.WarehouseId
